...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EntryContent.entry_author'
        db.add_column(u'timeline_entrycontent', 'entry_author',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['timeline.EntryAuthor'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EntryContent.entry_author'
        db.delete_column(u'timeline_entrycontent', 'entry_author_id')
    ...
    models = {
        ...
        u'magiccontent.widget': {
            ...
            'slug': ('django.db.models.fields.SlugField', [], {'default': "u'xm8zZKpuohTV'", 'max_length': '50'}),
