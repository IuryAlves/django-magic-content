...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EntryAuthor.user'
        db.alter_column(u'timeline_entryauthor', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True))
        # Adding unique constraint on 'EntryAuthor', fields ['user']
        db.create_unique(u'timeline_entryauthor', ['user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'EntryAuthor', fields ['user']
        db.delete_unique(u'timeline_entryauthor', ['user_id'])


        # Changing field 'EntryAuthor.user'
        db.alter_column(u'timeline_entryauthor', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
    ...
    models = {
        ...
        u'magiccontent.widget': {
            ...
            'slug': ('django.db.models.fields.SlugField', [], {'default': "u'9AHB0Pogky1q'", 'max_length': '50'}),
        ...
        u'timeline.entrycontent': {
            'Meta': {'ordering': "[u'order']", 'object_name': 'EntryContent'},
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'entry_access': ('django.db.models.fields.CharField', [], {'default': "u'public'", 'max_length': '30'}),
            'entry_author': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['timeline.EntryAuthor']"}),
            'entry_type': ('django.db.models.fields.CharField', [], {'max_length': '30'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
