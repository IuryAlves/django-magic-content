...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EntryContent.picture_cropping'
        db.add_column(u'timeline_entrycontent', 'picture_cropping',
                      self.gf(u'django.db.models.fields.CharField')(default=u'', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EntryContent.picture_cropping'
        db.delete_column(u'timeline_entrycontent', 'picture_cropping')
    ...
    models = {
        ...
        u'magiccontent.widget': {
            ...
            'slug': ('django.db.models.fields.SlugField', [], {'default': "u'wQm8SvsNoPvx'", 'max_length': '50'}),
