...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'EntryContent.entry_type'
        db.delete_column(u'timeline_entrycontent', 'entry_type')


    def backwards(self, orm):
        # Adding field 'EntryContent.entry_type'
        db.add_column(u'timeline_entrycontent', 'entry_type',
    ...
    models = {
        ...
        u'magiccontent.widget': {
            ...
            'slug': ('django.db.models.fields.SlugField', [], {'default': "u'BmyjBp52R49z'", 'max_length': '50'}),
