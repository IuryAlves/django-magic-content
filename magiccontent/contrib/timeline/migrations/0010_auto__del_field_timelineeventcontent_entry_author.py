...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TimelineEventContent.entry_author'
        db.delete_column(u'timeline_timelineeventcontent', 'entry_author_id')


    def backwards(self, orm):
        # Adding field 'TimelineEventContent.entry_author'
        db.add_column(u'timeline_timelineeventcontent', 'entry_author',
    ...
    models = {
        ...
        u'magiccontent.widget': {
            ...
            'slug': ('django.db.models.fields.SlugField', [], {'default': "u'nso78n9cuLvO'", 'max_length': '50'}),
