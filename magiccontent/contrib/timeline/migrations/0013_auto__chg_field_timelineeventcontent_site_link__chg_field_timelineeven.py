...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TimelineEventContent.site_link'
        db.alter_column(u'timeline_timelineeventcontent', 'site_link_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['magiccontent.SiteLink'], null=True, on_delete=models.SET_NULL))

        # Changing field 'TimelineEventContent.short_content'
        db.alter_column(u'timeline_timelineeventcontent', 'short_content', self.gf('django.db.models.fields.CharField')(max_length=512))

    def backwards(self, orm):

        # Changing field 'TimelineEventContent.site_link'
        db.alter_column(u'timeline_timelineeventcontent', 'site_link_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['magiccontent.SiteLink'], null=True))

        # Changing field 'TimelineEventContent.short_content'
        db.alter_column(u'timeline_timelineeventcontent', 'short_content', self.gf('django.db.models.fields.TextField')(max_length=512))
    ...
    models = {
        ...
        u'magiccontent.widget': {
            ...
            'site': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['sites.Site']"}),
            'slug': ('django.db.models.fields.SlugField', [], {'default': "u'1jfafyY5cg3G'", 'max_length': '50'}),
