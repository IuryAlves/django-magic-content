...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TimelineEventContent.picture_cropping'
        db.add_column(u'timeline_timelineeventcontent', 'picture_cropping',
                      self.gf(u'django.db.models.fields.CharField')(default=u'', max_length=255, blank=True),
                      keep_default=False)


        # Changing field 'TimelineEventContent.created'
        db.alter_column(u'timeline_timelineeventcontent', 'created', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):
        # Deleting field 'TimelineEventContent.picture_cropping'
        db.delete_column(u'timeline_timelineeventcontent', 'picture_cropping')


        # Changing field 'TimelineEventContent.created'
        db.alter_column(u'timeline_timelineeventcontent', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
    ...
    models = {
        ...
        u'magiccontent.widget': {
            ...
            'site': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['sites.Site']"}),
            'slug': ('django.db.models.fields.SlugField', [], {'default': "u'WnXEPXfk7x9A'", 'max_length': '50'}),
        ...
        u'timeline.timelineeventcontent': {
            'Meta': {'ordering': "[u'created']", 'object_name': 'TimelineEventContent'},
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 9, 29, 0, 0)'}),
