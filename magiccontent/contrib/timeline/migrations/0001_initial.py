...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'EntryContent'
        db.create_table(u'timeline_entrycontent', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('entry_author', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['timeline.EntryAuthor'])),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('entry_type', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('entry_access', self.gf('django.db.models.fields.CharField')(default=u'public', max_length=30)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=50)),
        ))
        db.send_create_signal(u'timeline', ['EntryContent'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'EntryContent'
        db.delete_table(u'timeline_entrycontent')
    ...
    models = {
        ...
        u'magiccontent.widget': {
            ...
            'slug': ('django.db.models.fields.SlugField', [], {'default': "u'zOuBBIpJYl2n'", 'max_length': '50'}),
