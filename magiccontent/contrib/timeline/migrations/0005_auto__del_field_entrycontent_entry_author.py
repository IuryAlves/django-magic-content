...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'timeline_entrycontent', 'entry_author',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['timeline.EntryAuthor']),
                      keep_default=False)
    ...
    models = {
        ...
        u'magiccontent.widget': {
            ...
            'slug': ('django.db.models.fields.SlugField', [], {'default': "u'2fQnZqJvY2CP'", 'max_length': '50'}),
