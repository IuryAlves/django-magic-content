...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DividerTextContent'
        db.create_table(u'dividertextcontent_dividertextcontent', (
        ...
        db.send_create_signal(u'dividertextcontent', ['DividerTextContent'])


    def backwards(self, orm):
        # Deleting model 'DividerTextContent'
        db.delete_table(u'dividertextcontent_dividertextcontent')


    models = {
        u'dividertextcontent.dividertextcontent': {
            'Meta': {'ordering': "[u'order']", 'object_name': 'DividerTextContent'},
        ...
        u'magiccontent.widget': {
            ...
            'site': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['sites.Site']"}),
            'slug': ('django.db.models.fields.SlugField', [], {'default': "u'n4K3yND1PW0n'", 'max_length': '50'}),
    ...
    complete_apps = ['dividertextcontent']