...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'imagecontent_imagecontent', (
        ...
        db.send_create_signal(u'imagecontent', ['ImageContent'])


    def backwards(self, orm):
        # Deleting model 'ImageContent'
        db.delete_table(u'imagecontent_imagecontent')
    ...
    models = {
        ...
        u'magiccontent.widget': {
            ...
            'site': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['sites.Site']"}),
            'slug': ('django.db.models.fields.SlugField', [], {'default': "u'NNqopX9zFyYq'", 'max_length': '50'}),
