...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PageLink.short_content'
        db.alter_column(u'pagelink_pagelink', 'short_content', self.gf('django.db.models.fields.CharField')(max_length=512))

        # Changing field 'PageLink.site_link'
        db.alter_column(u'pagelink_pagelink', 'site_link_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['magiccontent.SiteLink'], null=True, on_delete=models.SET_NULL))

    def backwards(self, orm):

        # Changing field 'PageLink.short_content'
        db.alter_column(u'pagelink_pagelink', 'short_content', self.gf('django.db.models.fields.TextField')(max_length=512))

        # Changing field 'PageLink.site_link'
        db.alter_column(u'pagelink_pagelink', 'site_link_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['magiccontent.SiteLink'], null=True))
    ...
    models = {
        ...
        u'magiccontent.widget': {
            ...
            'site': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['sites.Site']"}),
            'slug': ('django.db.models.fields.SlugField', [], {'default': "u'xkhHq6FlTzfO'", 'max_length': '50'}),
