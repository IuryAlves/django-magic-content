...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PageLink.link_url'
        db.delete_column(u'pagelink_pagelink', 'link_url')

        # Adding field 'PageLink.site_link'
        db.add_column(u'pagelink_pagelink', 'site_link',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['magiccontent.SiteLink'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'PageLink.link_url'
        db.add_column(u'pagelink_pagelink', 'link_url',
                      self.gf('django.db.models.fields.CharField')(default=u'', max_length=255, blank=True),
                      keep_default=False)

        # Deleting field 'PageLink.site_link'
        db.delete_column(u'pagelink_pagelink', 'site_link_id')
    ...
    models = {
        ...
        u'magiccontent.widget': {
            ...
            'site': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['sites.Site']"}),
            'slug': ('django.db.models.fields.SlugField', [], {'default': "u'TzoOeVgplNz4'", 'max_length': '50'}),
