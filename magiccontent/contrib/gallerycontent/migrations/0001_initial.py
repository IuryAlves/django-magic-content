...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'gallerycontent_gallerycontent', (
        ...
        db.send_create_signal(u'gallerycontent', ['GalleryContent'])


    def backwards(self, orm):
        # Deleting model 'GalleryContent'
        db.delete_table(u'gallerycontent_gallerycontent')


    models = {
        u'gallerycontent.gallerycontent': {
        ...
        u'magiccontent.widget': {
            ...
            'site': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['sites.Site']"}),
            'slug': ('django.db.models.fields.SlugField', [], {'default': "u'1dGSVZg7w2sW'", 'max_length': '50'}),
