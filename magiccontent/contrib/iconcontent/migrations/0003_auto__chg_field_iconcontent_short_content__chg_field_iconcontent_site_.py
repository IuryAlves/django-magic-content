...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'IconContent.short_content'
        db.alter_column(u'iconcontent_iconcontent', 'short_content', self.gf('django.db.models.fields.CharField')(max_length=512))

        # Changing field 'IconContent.site_link'
        db.alter_column(u'iconcontent_iconcontent', 'site_link_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['magiccontent.SiteLink'], null=True, on_delete=models.SET_NULL))

    def backwards(self, orm):

        # Changing field 'IconContent.short_content'
        db.alter_column(u'iconcontent_iconcontent', 'short_content', self.gf('django.db.models.fields.TextField')(max_length=512))

        # Changing field 'IconContent.site_link'
        db.alter_column(u'iconcontent_iconcontent', 'site_link_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['magiccontent.SiteLink'], null=True))

    models = {
        u'iconcontent.iconcontent': {
        ...
        u'magiccontent.widget': {
            ...
            'site': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['sites.Site']"}),
            'slug': ('django.db.models.fields.SlugField', [], {'default': "u'NNUPEf380tAx'", 'max_length': '50'}),
