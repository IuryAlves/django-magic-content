...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'iconcontent_iconcontent', (
        ...
        db.send_create_signal(u'iconcontent', ['IconContent'])


    def backwards(self, orm):
        # Deleting model 'IconContent'
        db.delete_table(u'iconcontent_iconcontent')
    ...
    models = {
        ...
        u'magiccontent.widget': {
            ...
            'site': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['sites.Site']"}),
            'slug': ('django.db.models.fields.SlugField', [], {'default': "u'x5t3a4LvgfVD'", 'max_length': '50'}),
