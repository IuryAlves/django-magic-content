...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SimpleContent.link_url'
        db.delete_column(u'simplecontent_simplecontent', 'link_url')

        # Adding field 'SimpleContent.site_link'
        db.add_column(u'simplecontent_simplecontent', 'site_link',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['magiccontent.SiteLink'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'SimpleContent.link_url'
        db.add_column(u'simplecontent_simplecontent', 'link_url',
                      self.gf('django.db.models.fields.CharField')(default=u'', max_length=255, blank=True),
                      keep_default=False)

        # Deleting field 'SimpleContent.site_link'
        db.delete_column(u'simplecontent_simplecontent', 'site_link_id')
    ...
    models = {
        ...
        u'magiccontent.widget': {
            ...
            'site': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['sites.Site']"}),
            'slug': ('django.db.models.fields.SlugField', [], {'default': "u'qsJjAXwKnUvo'", 'max_length': '50'}),
