...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'simplecontent_simplecontent', (
        ...
        db.send_create_signal(u'simplecontent', ['SimpleContent'])


    def backwards(self, orm):
        # Deleting model 'SimpleContent'
        db.delete_table(u'simplecontent_simplecontent')
    ...
    models = {
        u'magiccontent.widget': {
            ...
            'slug': ('django.db.models.fields.SlugField', [], {'default': "u'G8dcCvZ0wF1K'", 'max_length': '50'}),
