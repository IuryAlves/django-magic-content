...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'BackgroundArea.link_url'
        db.delete_column(u'background_backgroundarea', 'link_url')

        # Adding field 'BackgroundArea.site_link'
        db.add_column(u'background_backgroundarea', 'site_link',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['magiccontent.SiteLink'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'BackgroundArea.link_url'
        db.add_column(u'background_backgroundarea', 'link_url',
                      self.gf('django.db.models.fields.CharField')(default=u'', max_length=255, blank=True),
                      keep_default=False)

        # Deleting field 'BackgroundArea.site_link'
        db.delete_column(u'background_backgroundarea', 'site_link_id')
    ...
    models = {
        ...
        u'magiccontent.widget': {
            ...
            'site': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['sites.Site']"}),
            'slug': ('django.db.models.fields.SlugField', [], {'default': "u'z9epEKKW2D4g'", 'max_length': '50'}),
