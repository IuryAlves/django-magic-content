...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'background_backgroundarea', (
        ...
        db.send_create_signal(u'background', ['BackgroundArea'])


    def backwards(self, orm):
        # Deleting model 'BackgroundArea'
        db.delete_table(u'background_backgroundarea')
    ...
    models = {
        ...
        u'magiccontent.widget': {
            ...
            'site': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['sites.Site']"}),
            'slug': ('django.db.models.fields.SlugField', [], {'default': "u'YEATTNgmy3wc'", 'max_length': '50'}),
