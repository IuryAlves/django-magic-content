...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BackgroundArea.short_content'
        db.alter_column(u'background_backgroundarea', 'short_content', self.gf('django.db.models.fields.CharField')(max_length=512))

        # Changing field 'BackgroundArea.site_link'
        db.alter_column(u'background_backgroundarea', 'site_link_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['magiccontent.SiteLink'], null=True, on_delete=models.SET_NULL))

    def backwards(self, orm):

        # Changing field 'BackgroundArea.short_content'
        db.alter_column(u'background_backgroundarea', 'short_content', self.gf('django.db.models.fields.TextField')(max_length=512))

        # Changing field 'BackgroundArea.site_link'
        db.alter_column(u'background_backgroundarea', 'site_link_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['magiccontent.SiteLink'], null=True))

    models = {
        u'background.backgroundarea': {
        ...
        u'magiccontent.widget': {
            ...
            'site': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['sites.Site']"}),
            'slug': ('django.db.models.fields.SlugField', [], {'default': "u'5BulzZ3QK4Am'", 'max_length': '50'}),
