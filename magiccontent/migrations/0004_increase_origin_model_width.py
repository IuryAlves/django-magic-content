...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SiteLink.origin_model'
        db.alter_column(u'magiccontent_sitelink', 'origin_model', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'SiteLink.origin_model'
        db.alter_column(u'magiccontent_sitelink', 'origin_model', self.gf('django.db.models.fields.CharField')(max_length=40, null=True))
    ...
    models = {
        ...
        u'magiccontent.widget': {
            ...
            'site': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['sites.Site']"}),
            'slug': ('django.db.models.fields.SlugField', [], {'default': "u'fZI0WsAzk3wP'", 'max_length': '50'}),
