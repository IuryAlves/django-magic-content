...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SiteLink'
        db.create_table(u'magiccontent_sitelink', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('site', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sites.Site'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('url', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'magiccontent', ['SiteLink'])


    def backwards(self, orm):
        # Deleting model 'SiteLink'
        db.delete_table(u'magiccontent_sitelink')
    ...
    models = {
        ...
        u'magiccontent.widget': {
            ...
            'site': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['sites.Site']"}),
            'slug': ('django.db.models.fields.SlugField', [], {'default': "u'if4W1N3EUhdY'", 'max_length': '50'}),
