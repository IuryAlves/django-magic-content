...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SiteLink.referer'
        db.add_column(u'magiccontent_sitelink', 'referer',
                      self.gf('django.db.models.fields.CharField')(default=u'landingpage', max_length=20, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SiteLink.referer'
        db.delete_column(u'magiccontent_sitelink', 'referer')
    ...
    models = {
        ...
        u'magiccontent.widget': {
            ...
            'site': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['sites.Site']"}),
            'slug': ('django.db.models.fields.SlugField', [], {'default': "u'wxfdvmX8Abjt'", 'max_length': '50'}),
